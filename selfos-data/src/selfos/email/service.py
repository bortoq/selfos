...
from .delegation import suggest_email_with_trust, can_delegate_email
from scripts.create_task import create_task_event, save_event as save_activity_event
...
class EmailService:
    ...
    def __init__(self, provider: Optional[SMTPProvider] = None):
